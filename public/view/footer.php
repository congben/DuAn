<div class="footer">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="footer-logo logo-img">
                                        <img class="" src="" alt="Footer Logo">
                                        <p class="info">
                                        Chúng tôi là một nhóm gồm các nhà thiết kế và nhà phát triển tạo ra Mẫu HTML & Woocommerce, Chủ đề Shopify chất lượng cao.
                                        </p>
                                    </div>
                                    <ul class="des">
                                        <li>
                                            <span>Địa Chỉ </span>
                                            555 Nguyễn Tất Thành, Hồ Chí Minh
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <span>Email: </span>
                                            <a href="mailto://info@yourdomain.com">benncps32866@fpt.edu.vn</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-6">
                                    <div class="footer-block">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#">Sản Phẩm Tốt</a></li>
                                            <li><a href="#">Liện Hệ Chúng Tôi</a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-6">
                                    <div class="footer-block">
                                        <h3 class="footer-block-title">Team Chúng Tôi</h3>
                                        <ul>
                                            <li><a href="#">Vận chuyển</a></li>
                                            <li><a href="#">Thông báo pháp lý</a></li>
                                            <li><a href="about-us.php">Về Chúng Tôi</a></li>
                                            <li><a href="contact.php">Liện Hệ Chúng Tôi</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- Footer Block Area End Here -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="footer-links">
                                    <ul>
                                        ...
                                        <li><a href="#">Sản phẩm đặc biệt</a></li>
                                         ...
                                         <li><a href="#">Người được bảo hành</a></li>
                                ...
                                <div class="copyright text-center">
                                    <a href="#">
                                        <img src="view/images/payment/1.png" alt="">
                                    </a>
                                </div>
                                <!-- Footer Payment Area End Here -->
                                <!-- Begin Copyright Area -->
                                <div class="copyright text-center pt-25">
                                    <span><a href="https://www.templatespoint.net" target="_blank" >Chúng Bạn Mua Sắm Vui Vẻ</a></span>
                                </div>
                                   ...
                                   <!-- Product Details Left -->
                                    <div class="product-details-left">
                                        <div class="product-details-images slider-navigation-1">
                                            <div class="lg-image">
                                                <img src="view/images/product/large-size/1.jpg" alt="product image">
                                            </div>
                                            <div class="lg-image">
                                                <img src="view/images/product/large-size/2.jpg" alt="product image">
                                            </div>
                                            <div class="lg-image">
                                                <img src="view/images/product/large-size/3.jpg" alt="product image">
                                            </div>
                                            <div class="lg-image">
                                                <img src="view/images/product/large-size/4.jpg" alt="product image">
                                            </div>
                                            <div class="lg-image">
                                                <img src="view/images/product/large-size/5.jpg" alt="product image">
                                            </div>
                                            <div class="lg-image">
                                                <img src="view/images/product/large-size/6.jpg" alt="product image">
                                            </div>
                                        </div>
                                        <div class="product-details-thumbs slider-thumbs-1">                                        
                                            <div class="sm-image"><img src="view/images/product/small-size/1.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="view/images/product/small-size/2.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="view/images/product/small-size/3.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="view/images/product/small-size/4.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="view/images/product/small-size/5.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="view/images/product/small-size/6.jpg" alt="product image thumb"></div>
                                        </div>
                                    </div>
                                    <!--// Product Details Left -->
                                </div>
    ...
    <script src="view/js/googlemap.js"></script>
    </body>
